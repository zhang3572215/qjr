		...
		<div class='container'>
			<div class='list' v-for='(item,index) in list' :key='index' @click="gotoDetail(item.id,item.buyType)">
				...
				<div v-if='types!=3'>
					...
					<div class='list-center'>
						<div class='center-left'>
							<img class='left-img' v-if='item.productType==4' src='../assets/curtainIcon.png'></img>
							<img class='left-img' v-if='item.productType==7' src='../assets/curtainIcon.png'></img>
							<img class='left-img' v-if='item.productType==8' src='../assets/mattressIcon.png'></img>
							<img class='left-img' v-if='item.productType==9' src='../assets/mattressIcon.png'></img>
							<img class='left-img' v-if='item.productType==10' src='../assets/airIcon.png'></img>
						</div>
						<div class='center-tit'>
							<div class='content-info'>
								<div class="tit-info">
									<span v-if='item.productType==4'>窗帘清洗</span>
									<span v-if='item.productType==7'>水晶灯清洗</span>
									<span v-if='item.productType==8'>床垫清洗</span>
									<span v-if='item.productType==9'>石材养护</span>
									<span v-if='item.productType==10'>空调清洗</span>
									<span class='tit-right'>
										￥{{item.price}}
									</span>
								</div>
	...
	export default {
		...
		methods: {
			...
			getList() {
				...
				var url = ''
				if (this.types == 3) {
					url = '/carpet/t-carpet-order/getCarpetOrderByUserId'
				} else {
					url = '/technology/t-technology-order/getTecHistoryOrderByUserId'
					formdata.append('productType', this.types)
				}
