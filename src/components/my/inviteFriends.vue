<template>
	<div class='container'>
		...
		<head-Piece :sign='"清洁人注册邀请"'>
			<template slot="content">清洁人注册邀请</template>
			<div slot='content-right'  @click='invate'> <span v-if='!showWx'>立即邀请</span></div>
		</head-Piece>
	...
	export default {
		...
		methods: {
			...
			getImg() {
				...
				axios.post('/sys/t-sys-app-user/generateQRCode', params).then(res => {
					console.log(res)
					if (res.meta.success) {
