	...
	<div class='container' @scroll="scrollEvent">
		...
		<div class='head'>
			...
			<div class='head-right' @click="toShare">
				<img src='../../assets/share-shadow.png'></img>
			</div>
		</div>
		<div class='showHead' v-if='collageHead'>
			<div class='head'>
				...
				<div class='head-right' @click="toShare">
					<img src='../../assets/fenxiang.png'></img>
				</div>
			</div>
		</div>
		...
		<div class='content'>
			<div class='content-top'>
				...
				<div class='content-money'>
					...
					<div>
						<span class='newMoney'>￥<span class='newMoney-num'>{{assemblePrice}}</span></span>
			...
			<div class='content-title'>
				...
				<div class='title-second' v-if='this.type !=10 && this.type!=8'>
					满260元免拆装费（80元）和运费（80元）
				</div>
			...
			<div class='elastic-head'>
				<div class='elastic-head-first'>
					...
					<div>
						...
						<div class='elastic-head-tit' v-if='type==10'>空调清洗</div>
						<div class='elastic-head-tit' v-if='type==4'>窗帘清洗</div>
						<div class='elastic-head-tit' v-if='type==8'>床垫清洗</div>
						<div class='title-second'>
							标准服务，深度清洗
						</div>
						<div class='elastic-head-info'>
							<span class='new-money'>拼团价：{{assemblePrice}}</span>
...
<script>
	...
	export default {
		...
		methods: {
			...
			addNum(e) {
				this.categoryList[e]['num'] = this.categoryList[e]['num'] + 1
				this.addUp()
			},
			reduceNum(e) {
				if (this.categoryList[e]['num'] == 0) {
					this.$toast('数量不能小于0')
					return
				}
